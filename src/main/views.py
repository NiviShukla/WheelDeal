...
def inquire_listing_using_email(request, id):
    ...
    try:
        ...
        emailMessage = f'Hi {listing.seller.user.username}, {request.user.username} is interested in your {listing.model} listing on WheelDeal'
        send_mail(emailSubject, emailMessage, 'noreply@wheeldeal.com',
